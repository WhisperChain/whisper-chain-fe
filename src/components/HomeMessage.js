  ...
  return (
    <div className={`${styles.MessageBox}`}>
      ...
      <div className="flex relative justify-evenly mt-[50px] z-10">
        ...
        <div className={`flex justify-center items-center w-[80px] h-[80px] rounded-[8px] ${styles.ImageDiv}`}>
          <div className={`w-[53px] h-[34px] text-[#6F1AFF] ${styles.ImageDivText}`}>A.I. starts a thread</div>
        </div>
        <Image
          width={80}
          height={80}
