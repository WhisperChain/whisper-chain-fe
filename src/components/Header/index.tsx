  ...
  return (
    <div className={`px-[50px] ${styles.HeadComponent}`} id="Header">
      ...
      <div className="flex ml-auto gap-[16px]">
        ...
        <button onClick={handleOpen} className={` w-[92px] h-[36px] bg-[#FFFFFF] rounded-[40px] ${styles.SignInbtn}`}>
            Sign In
        </button>
        <CustomConnectButton />
      </div>
      <Modal
        ...
        style={customStyles}
      >
        <div className={`flex flex-col justify-center items-center bg-[#FFFFFF] rounded-[16px] backdrop-blur-3xl gap-[16px] p-[19px] ${styles.ModalContainer}`}>
            ...
            <button className={`flex justify-center box-border items-center w-[234px] h-[40px] backdrop-blur rounded-[4px] ${styles.LensContainer}`}>Sign in with Lens</button>
